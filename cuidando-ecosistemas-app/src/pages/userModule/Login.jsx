...
function Login() {
  return (
    <>
      <img className="w-full" src="./assets/bg-colors2.png" alt="" />
        ...
        <main className="mt-20">
          ...
          <form action="submit" className="text-center">
            ...
            <div className="flex justify-center">
              <Link to={'/home'} className="mt-5  rounded-full bg-emerald-500  p-4  text-white drop-shadow-xl shadow-emerald-700 text-xl">
                Iniciar sesión
              </Link>
            </div>
            ...
            <div className=" my-0 mx-auto mt-5 w-32 flex gap-4">
              <button className="">
                <img className="w-12" src="./assets/buscar.png" alt="" />
              </button>
              <button>
                <img className="w-12" src="./assets/facebook.png" alt="" />
              </button>
            </div>
          </form>
